...
- Added `sensor.py` exposing entities with appropriate `SensorDeviceClass` (`ENERGY`, `WATER`, `MONETARY`, `DATE`) and `SensorStateClass` compatible with Home Assistant's Energy Dashboard.
